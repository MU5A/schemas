...
const ResourceAccessSchema: Record<string, unknown> = {
  "openapi": "3.0.3",
  "info": {
    "title": "ResourceAccess",
    "description": "OpenAPI schema for the resource share/revoke contract in Meshery Cloud.",
    "version": "v1beta3",
    "contact": {
...
export default ResourceAccessSchema;
